      ...
      <div className=" flex flex-wrap justify-center align-middle gap-10">
        {FeatureData.map((data, index) => (
          <div key={index} className="relative h-44 category-item w-1/3 flex shadow-md cursor-pointer p-2 overflow-hidden  hover:bg-yellow-500">
            ...
            <h2 className="text-xl font-bold">{data.reviews}</h2>
            <h3 className="text-xl font-bold">{data.company}</h3>
            <h4 className="text-xl font-bold">{data.prevPrice}</h4>
            <h4 className="text-xl font-bold">{data.newPrice}</h4>
            <h5 className="text-xl font-bold">{data.color}</h5>
            <h6 className="text-xl font-bold">{data.category}</h6>
            </div>
